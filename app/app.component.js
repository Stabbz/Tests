System.register(['angular2/core', './exercise-detail.component', './exercise.service', 'angular2/http', 'rxjs/add/operator/toPromise'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(http, _exerciseService) {
                    this.http = http;
                ...
                AppComponent.prototype.addExercise = function (exName) {
                    var _this = this;
